...
Gem::Specification.new do |spec|
  ...
  spec.authors       = ["Developers at Rendered Text", "Richard Kramer"]
  spec.email         = ["devops@renderedtext.com", 'kramer@webit.de']

  spec.summary       = %q{Semaphore job parallelization.}
  spec.description   = %q{Gem for auto-parallelizing builds across Semaphore jobs.}
  spec.homepage      = "https://github.com/webit-de/test-boosters"
  spec.license       = "MIT"
